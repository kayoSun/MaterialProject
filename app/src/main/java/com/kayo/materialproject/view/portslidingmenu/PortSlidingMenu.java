package com.kayo.materialproject.view.portslidingmenu;
...
import com.kayo.materialproject.view.portslidingmenu.util.BlurUtil;
...
public class PortSlidingMenu extends ViewGroup {
    ...
    public PortSlidingMenu(Context context) {
        this(context, null);
    }

    public PortSlidingMenu(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void initObtainStyledAttr(Context context, AttributeSet attrs) {
        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.PortSlidingMenu);
        mType = array.getInteger(R.styleable.PortSlidingMenu_sm_type, 1111);
        mDragWipeOffset = (int) array.getDimension(R.styleable.PortSlidingMenu_sm_dragoffset, SizeUtil.Dp2Px(context, 100));
        mMenuOffset = (int) array.getDimension(R.styleable.PortSlidingMenu_sm_menuoffset, SizeUtil.Dp2Px(context, 50));
        mStartScale = array.getFloat(R.styleable.PortSlidingMenu_sm_startscale, 0.2f);
        mStartAlpha = array.getFloat(R.styleable.PortSlidingMenu_sm_startalpha, 0.2f);
        mStart3DAngle = array.getInteger(R.styleable.PortSlidingMenu_sm_start3dangle, 60);
        array.recycle();
    }
